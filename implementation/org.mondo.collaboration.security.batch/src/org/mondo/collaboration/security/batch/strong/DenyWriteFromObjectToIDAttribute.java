 ...
 *
 */
public class DenyWriteFromObjectToIDAttribute extends Consequence {
    private DenyWriteFromObjectToIDAttribute() {
    }

    public static Consequence instance = new DenyWriteFromObjectToIDAttribute();
